<%@ Page Title="" Language="C#" MasterPageFile="~/Reengineering.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Software_Reengineering.Register" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="CSS/Register.css" rel="stylesheet" type="text/css" />
    <table class="registerTable" style="width: 50%; margin: 50px auto 100px auto; border:2px solid yellowgreen;">
