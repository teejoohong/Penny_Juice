                ...
                while (dtr.Read())
                {
                    if (txtEmail.Text.Equals(dtr["Email"]))
                    {
                        ...
                        using (MailMessage mail = new MailMessage())
                        {
                            ...
                            mail.Subject = "Penny Juice Reset Password";
                            mail.Body = "Dear " + dtr["Username"].ToString() + ",<br /><br /> Please click the link below to reset your password: <br />"
                                + HttpContext.Current.Request.Url.AbsoluteUri.Replace("?view=0", "?view=1") + "&id=" + dtr["UserID"].ToString() + "&time=" + DateTime.Now.ToString("s") + "  <br/>This link only available for 15 minutes. <br /> Thank you! <br /><br /> Best Regards, <br /> Penny Juice.";
